...
final class PersonalRefreshTokenNotFound extends \Exception
{
    private const INVALID_USER_ID = "No se ha encontrado ningún token de refresco asociado al usuario %s";
